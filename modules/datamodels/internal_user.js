	...
	static field_descs =
		{
			...
			'email_work': new DataFieldDesc('email_work', 'work email', false, false, null),
			'email_home': new DataFieldDesc('email_home', 'personal email', true, false, null),
			'phone_ext': new DataFieldDesc('phone_ext', 'office ext', false, false, null),
			'phone_work': new DataFieldDesc('phone_work', 'work phone', false, true, null),
			'phone_home': new DataFieldDesc('phone_home', 'mobile phone', true, false, null),
			'address_work': new DataFieldDesc('address_work', 'work address', false, false, null),
			'address_home': new DataFieldDesc('address_home', 'home address', true, false, null),
