...
export class GlobalTooltip
{
	...
	{
		GlobalTooltip.e_tooltip_root = document.createElement('div');
		GlobalTooltip.e_tooltip_root.className = "global-tooltip-root";
		...
		GlobalTooltip.e_tooltip_fill = document.createElement('div');
		GlobalTooltip.e_tooltip_fill.className = "global-tooltip-fill";
		GlobalTooltip.e_tooltip_root.appendChild(GlobalTooltip.e_tooltip_fill);
		GlobalTooltip.e_tooltip_label = document.createElement('div');
		GlobalTooltip.e_tooltip_label.className = "global-tooltip-label";
		GlobalTooltip.e_tooltip_root.appendChild(GlobalTooltip.e_tooltip_label);

		document.body.appendChild(GlobalTooltip.e_tooltip_root);
	}
